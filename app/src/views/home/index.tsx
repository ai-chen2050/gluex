...
const content = {
    ...
    diagrams: [
      {
        ...
        url: 'https://mermaid.ink/img/eyJjb2RlIjogImdyYXBoIExSO0lzc3Vlci0tPkdvYWxWYXVsdDtHb2FsVmF1bHQtLT5UYWtlcjtUYWtlci0tPlByb29mO1Byb29mLS0-VmVyaWZpZXI7VmVyaWZpZXItLT5Hb2FsVmF1bHQiLCAibWVybWFpZCI6IHsidGhlbWUiOiAiZGFyayJ9fQ',
      },
      {
        ...
        url: 'https://mermaid.ink/img/eyJjb2RlIjogImdyYXBoIFREO1VzZXItLT5Sb2xlU3BhY2U7Um9sZVNwYWNlLS0-SGFiaXQ7Um9sZVNwYWNlLS0-VGFyZ2V0cztSb2xlU3BhY2UtLT5TdXJwcmlzZTtIYWJpdC0tPlZlcmlmaWVyO1RhcmdldHMtLT5WZXJpZmllcjtTdXJwcmlzZS0tPlZhdWx0IiwgIm1lcm1haWQiOiB7InRoZW1lIjogImZvcmVzdCJ9fQ',
      },
    ],
  ...
  zh: {
    heroTitle: 'GlueX：面向多角色关系的行为激励轨道',
        ...
        <div className="grid gap-6 md:grid-cols-2">
          {t.diagrams.map((diagram) => (
            <div key={diagram.title} className="rounded-3xl border border-base-300 bg-base-200/50 p-5 space-y-3">
              <img src={diagram.url} alt={diagram.title} className="w-full rounded-2xl bg-base-100" />
